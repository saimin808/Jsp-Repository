...
<body>
	...
	<ul>
		...
		<li>
			DTO로부터 값을 꺼내는 등의 간단한 자바 메서드 호출은 가능하지만
			모든 메서드를 자바처럼 자유롭게 사용할 수 있는 것은 아니다.
		</li>
	</ul>
	...
	<dl>
		...
		<dt>비교: ==, !=, eq(==), ne(!=),
				lt(less than <), gt(greater than >), le(less than equal <=), ge(greater than equal >=)</dt>
		<dd>
		...
		%>
		<dt>empty : 해당 값이 "" 또는 null일때 true</dt>
		<dd>
