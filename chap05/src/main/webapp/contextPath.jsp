...
<body>
	...
	<p>Context Path는 현재 프로젝트의 Context로 접근할 수 있는 경로를 의미한다</p>
	...
	<a href="<%= request.getContextPath() %>/encodingResult.jsp?samgim=스팸김치볶음제육&smoothie=딸기민트초코바나나"><%= request.getContextPath() %>/encodingResult.jsp</a> <br>
