...
<body>
	...
	<ul>
		...
		<li>글 목록을 볼 때 한 페이지에 10개씩 나오게 만들기</li>
	...
	<ul>
		...
		<li>목록 페이지의 적당한 위치에 글 쓰기 버튼을 만들고 <br>
			그 버튼을 누르면 글을 쓸 수 있는 폼이 있는 페이지로 넘아가기</li>
	</ul>
	
	<h3># 게시판 만들어보기 (3)</h3>
	
	<ul>
		<li>글 내용을 보는 곳에서 글 수정 버튼을 누르면 넘어가기</li>
	...
	<ul>
		<li>게시글 내용을 보는곳 아래에는 댓글을 입력할 수 있다.</li>
